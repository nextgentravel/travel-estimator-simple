...
export default new Vuex.Store({
  state: {
    ...
    estimate: {
        ...
        mealsAndIncidentals: { selected: false, amount: null, type: ""},
        transportation: { selected: false, amount: null},
        groundTransportation: { selected: false, amount: null},
        other: { selected: false, amount: null, description: ""},
    },
    training: false,
    conference: false,
    calculatedTotal: "-:--"
